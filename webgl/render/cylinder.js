...
function Cylinder(heightInVertices, topRadius, bottomRadius, partitions)
{
    var vertices = [];
    var indices = [];
    var normals = [];
    ...
    var heightInVertices, topRadius, bottomRadius, partitions;
    ...
    Mesh.call(this, Array.flatten(vertices), Array.flatten(indices), Array.flatten(normals), Array.flatten(uvs));
}
